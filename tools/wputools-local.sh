...
# CORE UPDATE TARGET VERSION
#_WPUTOOLS_CORE_UPDATE_TARGET="6.8.3";
...
# LOG ALL WPUTOOLS COMMANDS IN A CSV FILE
#_WPUTOOLS_COMMANDS_LOG="${_SOURCEDIR}wputools-usage.log";

# MANUAL CALLS IF CURL IS NOT WORKING
#_WPUTOOLS_MANUAL_CALL='1';
