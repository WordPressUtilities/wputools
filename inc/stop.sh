...
unset -f wputools_find_url_in_multisite;
...
unset -f wputools_is_website_id_valid;
unset -f wputools_is_wp_installed;
unset -f wputools_multisite_convert;
unset -f wputools_multisite_duplicate;
...
unset -v _WPUTOOLS_COMMANDS_LOG;
...
unset -v _WPUTOOLS_LOGIN_DOMAIN;
unset -v _WPUTOOLS_LOGIN_URL;
unset -v _WPUTOOLS_LOGIN_ID;
unset -v _WPUTOOLS_LOGIN_USER_ID;
