...
local _WPUTOOLS_VERSION='0.172.2';
...
if ! command -v $_PHP_COMMAND &> /dev/null; then
    echo "Error: PHP command not found: $_PHP_COMMAND";
    return 0;
fi;
...
case "$1" in
    ...
    ;;
    "adminer" | "anonymizedb" | "archivelogs" | "backup" | "bduser" | "cleanhack" | "codechecker" | "debugfile" | "detecthack" | "diagnostic" | "infos" | "language" | "login" | "go" | "duplicatemenu" |  "generatemenus" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "multisite-convert" | "multisite-duplicate" | "multisite-user" | "muplugin" | "nginx-convert" | "optimizeimage" | "plugin" | "quickinstall" | "sample" | "settings" | "search" | "wpuwoo")
