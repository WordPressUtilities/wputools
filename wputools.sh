...
local _WPUTOOLS_VERSION='0.63.0';
...
case "$1" in
    ...
    ;;
    "adminer" | "backup" | "bduser" | "cleanhack" | "codechecker" | "detecthack" | "diagnostic" | "login" | "go" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "muplugin" | "plugin" | "sample" | "settings" | "wpuwoo")
