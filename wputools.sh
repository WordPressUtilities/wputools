...
local _WPUTOOLS_VERSION='0.36.0';
local _PHP_VERSIONS=(7.0 7.1 7.2 7.3 7.4 8.0 8.1)
local _PHP_VERSIONS_OBSOLETES=(7.0 7.1 7.2)
...
case "$1" in
    ...
    ;;
    "adminer" | "backup" | "bduser" | "login" | "go" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "muplugin" | "plugin" | "sample" | "settings" | "wpuwoo")
