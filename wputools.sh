...
local _WPUTOOLS_VERSION='0.93.0';
...
case "$1" in
    ...
    ;;
    "adminer" | "archivelogs" | "backup" | "bduser" | "cleanhack" | "codechecker" | "detecthack" | "diagnostic" | "login" | "go" | "duplicatemenu" |  "generatemenus" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "muplugin" | "nginx-convert" | "plugin" | "sample" | "settings" | "wpuwoo")
