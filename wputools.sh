...
local _WPUTOOLS_VERSION='0.51.0';
...
case "$1" in
    ...
    ;;
    "adminer" | "backup" | "bduser" | "detecthack" | "diagnostic" | "login" | "go" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "muplugin" | "plugin" | "sample" | "settings" | "wpuwoo")
