...
local _WPUTOOLS_VERSION='0.45.4';
...
case "$1" in
    ...
    ;;
    "adminer" | "backup" | "bduser" | "diagnostic" | "login" | "go" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "muplugin" | "plugin" | "sample" | "settings" | "wpuwoo")
