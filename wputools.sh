...
local _WPUTOOLS_VERSION='0.157.0';
...
case "$1" in
    ...
    ;;
    "adminer" | "anonymizedb" | "archivelogs" | "backup" | "bduser" | "cleanhack" | "codechecker" | "debugfile" | "detecthack" | "diagnostic" | "language" | "login" | "go" | "duplicatemenu" |  "generatemenus" | "clean" | "update" | "cache" | "cachewarm" | "dbexport" | "dbimport" | "multisite-convert" | "multisite-duplicate" | "multisite-user" | "muplugin" | "nginx-convert" | "optimizeimage" | "plugin" | "quickinstall" | "sample" | "settings" | "search" | "wpuwoo")
